...
function PerfilUsuarios() {
    ...
    const [imagenesBD, setImagenBD]= useState("")
    ...
    useEffect(() => {
        async function fetchDataImagenes() {
            try {
                ...
                setImagenBD(imagenEncontrada);
                setImagenPreview(imagenEncontrada)
    ...
    const btnguardarPerfil = async () => {
        try {
            ...
            console.log(imagen);
            console.log(perrito);
            console.log(imagenesBD.Imagen);

            console.log(imagenPreview);
            
            let nuevaImagenURL = imagenesBD.Imagen;
            console.log(nuevaImagenURL);
                ...
                <div className="profile-left">
                    <div className="profile-image-container">
                        <div className="profile-image">
                            {<img src={imagenesBD.Imagen} alt="Imagen seleccionada" className="preview-img" /> ? (
