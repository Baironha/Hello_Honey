...
import imgPRUEBA from '../img/ChatGPT Image 19 jun 2025, 02_50_26 p.m..png'
function EconomiaHome() {
    ...
    const renderBoton = (id, texto) => (
        ...
        onClick={(e) => {
            ...
            toggleSeccion(id); // click simple solo si está oculto
            }
        }}
        >
    ...
    return (
        <div className="economia-page">
            ...
            <div id='Container_Inflación_Política_Monetaria'>
                ...
                <img src={imgPRUEBA} alt="" width={300} />
                <p>
                ...
                {renderBoton('Inflación_Política_Monetaria', 'Mostrar más')}
            ...
            <div id='Container_la_política_monetaria'>
                ...
                {renderBoton('la_política_monetaria', 'Mostrar más')}
                {seccionesVisibles['la_política_monetaria'] && (
                    <div id='Cont_desple_la_política_monetaria'>
                        <p>
                        ...
                        <p>
                            La política monetaria es una herramienta poderosa que, como si fuera un “container”, guarda los instrumentos necesarios para guiar la economía hacia <br />
                            ...
                            monetaria seguirá siendo uno de los pilares fundamentales para sostener economías sanas y sociedades más equilibradas.
                        </p>
                    </div>
                )}
            </div>
            ...
            <div id='container_Mercados_Financieros_Bolsa_Valores'>
                ...
                {renderBoton('Mercados_Financieros_Bolsa_Valores', 'Mostrar más')}
                {seccionesVisibles['Mercados_Financieros_Bolsa_Valores'] && (
            ...
            <div id='container_Recesión_Crecimiento_Económico'>
                ...
                {renderBoton('Recesión_Crecimiento_Económico', 'Mostrar más')}
                {seccionesVisibles['Recesión_Crecimiento_Económico'] && (
            ...
            <div id='container_Globalización_Comercio_Internacional'>
                ...
                <p>
                    La globalización y el comercio internacional son fenómenos interrelacionados que han transformado la economía mundial en las últimas décadas. Gracias a los avances tecnológicos, la reducción de barreras comerciales y la <br />
                    ...
                    para analizar el rumbo de las sociedades contemporáneas.
                </p>
                {renderBoton('Globalización_Comercio_Internacional', 'Mostrar más')}
                {seccionesVisibles['Globalización_Comercio_Internacional'] && (
                    <div id='cont_seg_Globalización_Comercio_Internacional'>
                        ...
                        <p><strong>La globalización y el comercio internacional han sido motores clave del crecimiento económico mundial. Han permitido una mayor integración de los países, el acceso a productos <br />
                            ...
                            para el desarrollo inclusivo, no solo para el enriquecimiento de unos pocos.
                        </strong></p>
                    </div>
                )}
            </div>
            ...
            {renderBoton('Transformación_Digital_Finanzas_Tecnológicas', 'Mostrar más')}
            {seccionesVisibles['Transformación_Digital_Finanzas_Tecnológicas'] && (
